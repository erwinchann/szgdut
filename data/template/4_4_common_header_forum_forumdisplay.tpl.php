...
0
|| checktplrefresh('./template/wekei_com_140520_new_feel/common/header.htm', './template/default/common/header_common.htm', 1402331437, '4', './data/template/4_4_common_header_forum_forumdisplay.tpl.php', './template/wekei_com_140520_new_feel', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/wekei_com_140520_new_feel/common/header.htm', './template/default/common/header_qmenu.htm', 1402331437, '4', './data/template/4_4_common_header_forum_forumdisplay.tpl.php', './template/wekei_com_140520_new_feel', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/wekei_com_140520_new_feel/common/header.htm', './template/default/common/pubsearchform.htm', 1402331437, '4', './data/template/4_4_common_header_forum_forumdisplay.tpl.php', './template/wekei_com_140520_new_feel', 'common/header_forum_forumdisplay')
;?>
...
<div  class="wp" style="margin-top:20px;"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
